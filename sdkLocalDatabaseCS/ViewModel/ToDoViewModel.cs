...
namespace LocalDatabaseSample.ViewModel
{
    public class ToDoViewModel : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<ToDoItem> _paniniToDoItems;
        public ObservableCollection<ToDoItem> PaniniToDoItems
        {
            get { return _paniniToDoItems; }
            set
            {
                _paniniToDoItems = value;
                NotifyPropertyChanged("PaniniToDoItems");
            }
        }

        // To-do items associated with the work category.
        private ObservableCollection<ToDoItem> _bevandeToDoItems;
        public ObservableCollection<ToDoItem> BevandeToDoItems
        {
            get { return _bevandeToDoItems; }
            set
            {
                _bevandeToDoItems = value;
                NotifyPropertyChanged("BevandeToDoItems");
            }
        }

        // To-do items associated with the hobbies category.
        private ObservableCollection<ToDoItem> _panificatiToDoItems;
        public ObservableCollection<ToDoItem> PanificatiToDoItems
        {
            get { return _panificatiToDoItems; }
            set
            {
                _panificatiToDoItems = value;
                NotifyPropertyChanged("PanificatiToDoItems");
            }
        }
        ...
        public void LoadCollectionsFromDatabase()
        {
            ...
            foreach (ToDoCategory category in toDoCategoriesInDB)
            {
                ...
                {
                    case "Panini":
                        PaniniToDoItems = new ObservableCollection<ToDoItem>(category.ToDos);
                        break;
                    case "Bevande":
                        BevandeToDoItems = new ObservableCollection<ToDoItem>(category.ToDos);
                        break;
                    case "Panificati":
                        PanificatiToDoItems = new ObservableCollection<ToDoItem>(category.ToDos);
                        break;
                    default:
                        break;
                }
        ...
        public void AddToDoItem(ToDoItem newToDoItem)
        {
            ...
            {
                case "Panini":
                    PaniniToDoItems.Add(newToDoItem);
                    break;
                case "Bevande":
                    BevandeToDoItems.Add(newToDoItem);
                    break;
                case "Panificati":
                    PanificatiToDoItems.Add(newToDoItem);
                    break;
                default:
                    break;
            }
        ...
        public void DeleteToDoItem(ToDoItem toDoForDelete)
        {
            ...
            {
                case "Panini":
                    PaniniToDoItems.Remove(toDoForDelete);
                    break;
                case "Bevande":
                    BevandeToDoItems.Remove(toDoForDelete);
                    break;
                case "Panificati":
                    PanificatiToDoItems.Remove(toDoForDelete);
                    break;
                default:
                    break;
            }
